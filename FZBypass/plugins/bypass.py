...
🛃 <b>Use Me Here :</b> @TomenLMGroup <i>(Bypass Topic)</i>''',
        quote=True,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton('Owner', url='https://t.me/TomenBots'), InlineKeyboardButton('Use At', url="https://github.com/SilentDemonSD/TomenLMGroup")]
            ])
    )
